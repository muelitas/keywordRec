'''/**************************************************************************
    File: AO_create_phonemes_dict.py
    Author: Mario Esparza
    Date: 03/04/2021
    
    Use AOLME's custom transcript to create a vocabulary dictionary. Create
...
L = 'en-us' #DON'T FORGET TO CHANGE THIS  BEFORE RUNNING!!!
dict_txt = root + '/dict/AO_en_dict.txt'
dict_pickle = root + '/dict/AO_en_dict.pickle'
transcr_path = root + '/spctrgrms/clean/AO_EN/transcript.txt'
...
#Get vocabulary, list of unique words in Kaggles's transcript
print("Processing AOLME's Transcript...")
vocabulary = []
