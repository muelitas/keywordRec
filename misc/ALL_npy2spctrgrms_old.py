...
def TS_npy_to_spctrgrms(tts_gtts, SR, mels):
    ...
    for idx, line in enumerate(lines[:5]):
        ...
        temp_path = f"/home/mario/Desktop/{idx}.wav"
...
TS = {'old_transcr': '/media/mario/audios/spanish_custom/transcript.txt',
      'new_transcr': '/media/mario/audios/TS_x4_spctrgrms_v3/TSx4_0/transcript.txt',
      'dst_dir': '/media/mario/audios/TS_x4_spctrgrms_v3/TSx4_0',
      'npy_file': '/media/mario/audios/PyRoom/TSx4v3/TS_DA_0.npy'}
