'''/**************************************************************************
    File: TS_audios2spctrgrms.py
    Author: Mario Esparza
    Date: 03/07/2021
    
    Grab custom transcript and get audios listed in such. Calculate
    spectrogram of each audio and save in specified folder. Normalize values
    before saving. Calculate duration of audio and add it to new transcript.
    Check if audios don't have a {SR} sample rate. If audios duration is under
    a given threshold, pad it with given number of zeros.
...
old_transcr_path = '/media/mario/audios/spanglish_custom/transcript.txt'
dst_dir = data_root + '/spctrgrms/clean/TS_spang'
new_transcr_path = dst_dir + '/transcript.txt'
SR = 16000 #Sample Rate
mels = 128
#I also used 300 and 4096 (respectively) for AOLME
...
print("Processing gTTS_TTS's spanglish audios...")
