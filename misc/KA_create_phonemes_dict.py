'''/**************************************************************************
    File: KA_create_phonemes_dict.py
    Author: Mario Esparza
    Date: 03/02/2021
    
    Use Kaggles's custom transcript to create a vocabulary dictionary. Create
...
dict_txt = root + '/dict/ka_dict.txt'
dict_pickle = root + '/dict/ka_dict.pickle'
transcr_path = root + '/spctrgrms/clean/KA/transcript.txt'
...
print("Processing Kaggles's Transcript...")
vocabulary = []
