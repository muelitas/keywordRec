...
class SpeechRecognitionModel(nn.Module):
    def __init__(self, hparams, num_of_classes):        
        ...
        if hparams['gru_hid_dim']*2 <= num_of_classes:
            fc_out_ftrs = num_of_classes
        else:
            fc_out_ftrs = (hparams['gru_hid_dim']*2 - num_of_classes) // 2
            fc_out_ftrs += num_of_classes
        ...
        self.classifier = nn.Sequential(
            ...
            nn.Linear(fc_out_ftrs, num_of_classes)
        )
