...
from utils import data_processing, train, dev, Metrics, CUSTOM_DATASET, \
    plot_and_save, log_message, error, LR_SCHED, \
...
#TTS and gTTS's dataset (run through pyroom, 4 diff. locations)
TSx4 = {
    'dataset_ID': 'TSx4',
    'use_dataset': 0,
    'dict': data_root + '/dict/ts_dict.pickle',
...
if TRAIN: #--------------------------------------------------------   
    ...
    optimizer = optim.AdamW(oparams, hparams['e_0'])
